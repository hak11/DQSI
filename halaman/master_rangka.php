...
<div class="box">
  <div class="box-header with-border">
    <h3 class="box-title">Master Rangka</h3>
    <div class="box-tools pull-right">
      <a type="button" class="btn btn-success" href="index.php?hal=tambah_master_rangka">Tambah Data</a>
    </div>
  </div>
  <div class="box-body">
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="table-responsive">
          <table class="table table-hover datatables-basic">
            ...
            <tbody role="rowgroup">
            <?php
            $query = "SELECT * from master_rangka";
